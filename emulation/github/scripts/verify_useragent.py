...
Cloudflare observed UNC6395 hitting a token verification endpoint on
2025-08-09 with the literal HTTP header
...
GTIG lists four separate User-Agents for the same campaign. See
profile/README.md section 11 for those.
