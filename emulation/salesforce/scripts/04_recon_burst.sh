...
echo "Next: capture the System Overview API Usage screenshot as the free-tier substitute for OAuth Usage (Setup -> System Overview -> API Usage tile). The legacy Connected Apps OAuth Usage page is not exposed for External Client Apps in Developer Edition."
