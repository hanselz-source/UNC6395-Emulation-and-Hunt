...
if [ ! -f "$KEYS_DIR/consumer_key" ]; then
  ...
  echo "  Copy keys/consumer_key.example to keys/consumer_key and paste in your own value." >&2
  echo "  Salesforce Setup -> External Client App Manager -> your app -> Settings -> OAuth Settings" >&2
  echo "  See keys/README.md." >&2
  exit 1
fi
